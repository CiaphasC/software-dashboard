...
import { Eye, EyeOff, ShieldCheck, User, Lock, Sparkles, Zap, Activity, BarChart3, UserPlus } from 'lucide-react';
...
const Login: React.FC = () => {
  ...
  // Si se muestra el registro, renderizar el componente Register
  if (showRegister) {
