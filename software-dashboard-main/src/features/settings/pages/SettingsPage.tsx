    ...
    <div className="space-y-6">
      ...
      >
          ...
          <ToggleSetting
            ...
            enabled={config?.notifications.email || false}
            onToggle={() => handleSettingChange('notifications', 'email', !config?.notifications.email)}
            icon={Mail}
          />
          <ToggleSetting
            title="Notificaciones Push"
            description="Recibir notificaciones push en el navegador"
            enabled={config?.notifications.push || false}
            onToggle={() => handleSettingChange('notifications', 'push', !config?.notifications.push)}
            icon={Smartphone}
          />
          <ToggleSetting
            title="Notificaciones de Escritorio"
            description="Notificaciones en el navegador"
            enabled={config?.notifications.desktop || false}
            onToggle={() => handleSettingChange('notifications', 'desktop', !config?.notifications.desktop)}
            icon={Monitor}
          />
          <ToggleSetting
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <div className="space-y-4">
            <div>
              ...
              <Input
                type="number"
                value={Math.floor((config?.security.sessionTimeout || 3600) / 60)}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleSettingChange('security', 'passwordPolicy', { ...config?.security.passwordPolicy, minLength: parseInt(e.target.value) })}
                min="6"
                max="20"
                className="bg-white/50 border-gray-200 focus:border-red-500 focus:ring-red-500/20"
              />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                value={config?.appearance.colorScheme || 'light'}
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <StatCard
            ...
            value={config?.system?.lastUpdate?.toLocaleDateString('es-PE') || new Date().toLocaleDateString('es-PE')}
            icon={Calendar}
