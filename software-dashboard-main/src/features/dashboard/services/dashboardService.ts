/**
 * SERVICIO DEL DASHBOARD - CONEXIÓN CON SUPABASE
 * 
 * Este archivo contiene toda la lógica de conexión con Supabase para el dashboard.
 ...
 * Contiene todos los métodos para interactuar con Supabase
 */
export class DashboardService {
  /**
   * Obtiene las métricas del dashboard desde Supabase
   * 
   * Conecta con: dataService.getDashboardMetrics()
  ...
  /**
   * Refresca las métricas del dashboard desde Supabase
   * 
   * Conecta con: dataService.getDashboardMetrics()
  ...
  /**
   * Obtiene métricas específicas por filtro desde Supabase
   * 
   * Conecta con: dataService.getDashboardMetrics() (futuro: endpoint con filtros)
   ...
   * 
   * Conecta con: dataService.getDashboardMetrics() (futuro: endpoint de tiempo real)
  ...
  /**
   * Exporta datos del dashboard desde Supabase
   * 
   * Conecta con: dataService.getDashboardMetrics() (futuro: endpoint de exportación)
   ...
   * 
   * Conecta con: Supabase para verificar timestamp de última actualización
