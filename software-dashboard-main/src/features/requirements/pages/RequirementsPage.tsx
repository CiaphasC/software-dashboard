...
import { RequirementsFloatingParticles } from '@/shared/components/ui';
...
export const RequirementsPage: React.FC = () => {
  ...
  const handleViewRequirementModal = (requirement: Requirement) => {
    handleViewRequirement(requirement);
  };

  const handleEditRequirementModal = (requirement: Requirement) => {
    if (!isAdmin) {
      toast.error('Solo los administradores pueden editar requerimientos');
      return;
    }
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <RequirementsTable
                ...
                onEditRequirement={handleEditRequirementModal}
                onDeleteRequirement={handleDeleteRequirement}
                onViewRequirement={handleViewRequirementModal}
              />
            </motion.div>
          </AnimatePresence>
        </motion.div>
